...
//        float f = 3.14;   // Ошибка. Так же как и в целочисленных типах данных, по дефолту числа с плав. точкой приводятся к типу double
        ...
        * Класс String не может иметь потомков, поэтому он обозначен как final
        * Также класс String является immutable, то есть созданный объект класса String нельзя изменить после его создания */
        int createJava = 1995;
        String str = "Java was created in ->" + createJava;//Если символьная строка складывается со значением другого типа, то это значение другого типа преобразуется в символьную строку
        ...
        /*Также если сравнить одинаковые строки через оператор == то результат будет всегда true, т.к этих строк одинаковый адрес в памяти*/
         String strCompare1 = "JavaScript";
         String strCompare2 = "JavaScript";
        System.out.println(strCompare1==strCompare2);


        /*Перевод строки в число*/
        Double u = Double.parseDouble("65.64");
